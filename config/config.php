...
/**
 * Backend-Bereich MIVIS anlegen, wenn noch nicht vorhanden
 */
if(!$GLOBALS['BE_MOD']['mivis']) 
{
	array_insert($GLOBALS['BE_MOD'], 0, array('mivis' => array()));
}


$GLOBALS['BE_MOD']['mivis']['mivis_vereinsliste'] = array
(
	'tables'       	=> array('tl_mivis_vereine', 'tl_mivis_spieler'),
	'icon'         	=> 'system/modules/mivis/assets/icons/mivis_16.png',
	'import'        => array('Transfer', 'importMIVIS')
);

//$GLOBALS['BE_MOD']['mivis']['mivis_rechte'] = array
//(
//	'tables'       	=> array('tl_mivis_rechte'),
//	'icon'         	=> 'system/modules/mivis/assets/icons/rechte.png',
//);

/**
 * Add permissions
 */
$GLOBALS['TL_PERMISSIONS'][] = 'mivis'; // Erlaubte Vereine
$GLOBALS['TL_PERMISSIONS'][] = 'mivisv'; // Vereinsrechte
$GLOBALS['TL_PERMISSIONS'][] = 'mivism'; // Mitgliederrechte
//$GLOBALS['TL_PERMISSIONS'][] = 'mivisc'; // Felderrechte
