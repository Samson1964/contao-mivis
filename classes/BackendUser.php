...
class BackendUser extends \User
{
	...
	public function __get($strKey)
	{
		switch ($strKey)
		{
			...
			case 'alexf': // Array mit erlaubten Feldern (Core)
				return $this->alexf;
				break;

			case 'modules': // Array mit erlaubten Modulen
				return $this->arrData['modules'];
				break;

			case 'mivis': // Array mit Rechten für Vereine Mivis
				return $this->arrData['mivis'];
				break;

			case 'mivisv': // Array mit Rechten für tl_mivis_vereine
				return $this->arrData['mivisv'];
				break;

			case 'mivisc': // Array mit Rechten für Felder Mivis
				return $this->arrData['mivisc'];
				break;
		}
	 ...
	 * @return mixed
	 */
	public function __set($strKey, $arrValue)
	{
		switch ($strKey)
		{
			case 'alexf':
			...
			case 'modules': // Array mit erlaubten Modulen
				$this->arrData['modules'] = $arrValue;
				break;

			case 'mivis': // Array mit Rechten für Vereine Mivis
				$this->arrData['mivis'] = $arrValue;
				break;

			case 'mivisv': // Array mit Rechten für tl_mivis_vereine
				$this->arrData['mivisv'] = $arrValue;
				break;

			case 'mivisc': // Array mit Rechten für Felder Mivis
				$this->arrData['mivisc'] = $arrValue;
				break;
		}

		return parent::__set($strKey, $arrValue);
	}
